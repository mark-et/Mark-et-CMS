<?php /* Smarty version Smarty-3.1.18, created on 2016-03-24 19:58:39
         compiled from "backend\design\html\orders.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2201456f446ef17c193-88202902%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2201456f446ef17c193-88202902',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56f446ef66f814_84082441',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56f446ef66f814_84082441')) {function content_56f446ef66f814_84082441($_smarty_tpl) {?>
<?php $_smarty_tpl->_capture_stack[0][] = array('tabs', null, null); ob_start(); ?>
    <?php if (in_array('orders',$_smarty_tpl->tpl_vars['manager']->value->permissions)) {?>
        <li <?php if ($_smarty_tpl->tpl_vars['status']->value===0) {?>class="active"<?php }?>>
            <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('module'=>'OrdersAdmin','status'=>0,'keyword'=>null,'id'=>null,'page'=>null,'label'=>null,'from_date'=>null,'to_date'=>null),$_smarty_tpl);?>
">Новые</a>
        </li>
        <li <?php if ($_smarty_tpl->tpl_vars['status']->value==1) {?>class="active"<?php }?>>
            <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('module'=>'OrdersAdmin','status'=>1,'keyword'=>null,'id'=>null,'page'=>null,'label'=>null,'from_date'=>null,'to_date'=>null),$_smarty_tpl);?>
">Приняты</a>
        </li>
        <li <?php if ($_smarty_tpl->tpl_vars['status']->value==2) {?>class="active"<?php }?>>
            <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('module'=>'OrdersAdmin','status'=>2,'keyword'=>null,'id'=>null,'page'=>null,'label'=>null,'from_date'=>null,'to_date'=>null),$_smarty_tpl);?>
">Выполнены</a>
        </li>
        <li <?php if ($_smarty_tpl->tpl_vars['status']->value==3) {?>class="active"<?php }?>>
            <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('module'=>'OrdersAdmin','status'=>3,'keyword'=>null,'id'=>null,'page'=>null,'label'=>null,'from_date'=>null,'to_date'=>null),$_smarty_tpl);?>
">Удалены</a>
        </li>
        <?php if ($_smarty_tpl->tpl_vars['keyword']->value) {?>
            <li class="active">
                <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('module'=>'OrdersAdmin','keyword'=>$_smarty_tpl->tpl_vars['keyword']->value,'id'=>null,'label'=>null,'from_date'=>null,'to_date'=>null),$_smarty_tpl);?>
">Поиск</a>
            </li>
        <?php }?>
    <?php }?>
    <?php if (in_array('labels',$_smarty_tpl->tpl_vars['manager']->value->permissions)) {?>
        <li><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('module'=>'OrdersLabelsAdmin','keyword'=>null,'id'=>null,'page'=>null,'label'=>null,'from_date'=>null,'to_date'=>null),$_smarty_tpl);?>
">Метки</a></li>
    <?php }?>
...
?>
                    <div class="<?php if ($_smarty_tpl->tpl_vars['order']->value->paid) {?>green<?php }?> row">
                        <div class="checkbox cell">
                            <input type="checkbox" id="<?php echo $_smarty_tpl->tpl_vars['order']->value->id;?>
" name="check[]" value="<?php echo $_smarty_tpl->tpl_vars['order']->value->id;?>
"/>
                            <label for="<?php echo $_smarty_tpl->tpl_vars['order']->value->id;?>
"></label>
                        </div>
...
"></span>
                            ...
                            <div class="order_info_wrap">
                                 <a class="show_purchases" href="javascript:;"><span><?php echo count($_smarty_tpl->tpl_vars['order']->value->purchases);?>
</span><i class="info_icon"></i></a>

                                <div class="order_info">
                                    <p>Товары в заказе №<?php echo $_smarty_tpl->tpl_vars['order']->value->id;?>
</p>
...
?>
                                            <tr>
                                                ...
                                                <?php if ($_smarty_tpl->tpl_vars['purchase']->value->variant_name) {?>(<?php echo $_smarty_tpl->tpl_vars['purchase']->value->variant_name;?>
)<?php }?>
                                                </td>
...
">
        ...
        <div class="form_group">
           <label for="from_date">C</label>
            <input class="okay_inp" type="text" id="from_date" name="from_date" value="<?php echo $_smarty_tpl->tpl_vars['from_date']->value;?>
" autocomplete="off"> 
        </div>

         <div class="form_group">
            <label for="to_date">По</label>
            <input class="okay_inp" type="text" id="to_date" name="to_date" value="<?php echo $_smarty_tpl->tpl_vars['to_date']->value;?>
" autocomplete="off">
         </div>
    ...
    <?php if ($_smarty_tpl->tpl_vars['labels']->value) {?>
        <ul id="labels">
            <li <?php if (!$_smarty_tpl->tpl_vars['label']->value) {?>class="selected"<?php }?>>
                <span class="label"></span>
                <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('label'=>null),$_smarty_tpl);?>
">Все заказы</a>
            </li>
            <?php  $_smarty_tpl->tpl_vars['l'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['l']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['labels']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
