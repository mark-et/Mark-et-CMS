<?php /* Smarty version Smarty-3.1.18, created on 2016-03-24 20:05:52
         compiled from "backend\design\html\translation.tpl" */ ?>
<?php /*%%SmartyHeaderCode:42956f448a0df0327-39711025%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '42956f448a0df0327-39711025',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56f448a161ca64_77045782',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56f448a161ca64_77045782')) {function content_56f448a161ca64_77045782($_smarty_tpl) {?><?php $_smarty_tpl->_capture_stack[0][] = array('tabs', null, null); ob_start(); ?>
    ...
    <?php if (in_array('languages',$_smarty_tpl->tpl_vars['manager']->value->permissions)) {?><li><a href="index.php?module=LanguagesAdmin">Языки</a></li><?php }?>
...
<div class="message message_error">
    ...
    <?php if ($_smarty_tpl->tpl_vars['message_error']->value=='label_is_class') {?>Метка с именем определённым в api/Okay.php не допустима!!!<?php }?>
    </span>
	<a class="button" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('module'=>'TranslationsAdmin'),$_smarty_tpl);?>
">Вернуться</a>
</div>
